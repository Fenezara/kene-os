...
async function main() {
  console.log('🌱 Seed database Kènè Pro (Mode pur JS)...');
  ...
  // 4. Tenant Démo (Salon Kènè Dakar)
  ...
  // 12. Écritures Comptables SYSCOHADA
  ...
  console.log('✅ Base de données Kènè Pro alimentée avec succès (Base SQLite Démo) !');
}
