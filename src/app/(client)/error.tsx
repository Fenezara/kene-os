  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center bg-[#0F0A05] text-white">
      ...
      <p className="text-xs text-white/60 max-w-md mx-auto mb-4">
        Une mise à jour de l'interface a été appliquée. Cliquez sur "Réessayer" pour charger immédiatement le nouveau portail.
      </p>
      ...
      {error?.message && (
        <div className="mb-6 max-w-lg w-full bg-red-950/40 border border-red-500/40 rounded-2xl p-3 text-left font-mono text-[11px] text-red-200 overflow-x-auto">
          <div className="font-bold text-red-400 mb-1">Détails :</div>
      ...
      <div className="flex items-center gap-3 flex-wrap justify-center">
        <Button
          ...
          className="bg-gradient-to-r from-[var(--gold-kene)] to-[#D4AF37] text-black font-bold text-xs rounded-xl h-10 px-5 shadow-lg flex items-center gap-2 cursor-pointer hover:scale-105 transition"
        >
          <RefreshCw className="w-4 h-4" /> Réessayer / Recharger
        </Button>
